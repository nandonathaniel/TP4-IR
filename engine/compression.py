...
class VBEPostings:
    ...
    def vb_encode(list_of_numbers):
        ...
        for number in list_of_numbers:
            result += VBEPostings.vb_encode_number(number)
    ...
    def encode(postings_list):
        ...
        """
        # TODO
        result = [postings_list[0]] + [postings_list[i+1]-postings_list[i]
                                       for i in range(len(postings_list)-1)]
        return VBEPostings.vb_encode(result)
    ...
    def decode(encoded_postings_list):
        ...
        """
        # TODO
        result = VBEPostings.vb_decode(encoded_postings_list)
